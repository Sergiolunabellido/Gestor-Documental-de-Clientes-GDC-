<div  class="vh-100 w-25 float-start ">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark h-100 w-100 align-items-center rounded" >
 
        <span class="fs-4">Paginas</span>
